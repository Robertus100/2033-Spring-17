...
\newthought{\textit{Check Your Understanding: }}Let $A$, $B$, and $C$ be disjoint \marginnote{\color{teal} Please don't read the answers before attempting the questions.}subsets of the sample space. For each one of the following statements, determine whether it is true or false. Note: "False" means "not guaranteed to be true."
...
\newthought{\textit{Check Your Understanding: }}Let $A$, $B$, and $C$ be subsets \marginnote{\color{teal} Please don't read the answers before attempting the questions.}of the sample space, not necessarily disjoint. For each one of the following statements, determine whether it is true or false. Note: "False" means "not guaranteed to be true."
...
\newthought{\textit{Check Your Understanding: }}Consider the same model \marginnote{\color{teal} Please don't read the answers before attempting the questions.}of two rolls of a tetrahedral die, with all 16 outcomes equally likely. Find the probability of the following events:
\begin{enumerate}
...
\newthought{\textit{Check Your Understanding: }} Consider a sample space \marginnote{\color{teal} Please don't read the answers before attempting the questions.}that is the rectangular region
